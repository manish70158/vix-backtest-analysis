#!/usr/bin/env python3
"""
NIFTY Expiry Day VIX vs Movement Backtester V2 (Weekly + Monthly)
...
class NiftyAllExpiriesBacktester:
    ...
    def export_results(self, backtest_results: Dict, filename: str = "vix_all_expiries_results_v2.json"):
    ...
    def export_csv(self, backtest_results: Dict, filename: str = "vix_all_expiries_results_v2.csv"):
...
def main():
    ...
    parser.add_argument('--json', type=str, default='vix_all_expiries_results_v2.json', help='JSON output filename')
    parser.add_argument('--csv', type=str, default='vix_all_expiries_results_v2.csv', help='CSV output filename')
