...
|--------|------|-------------|
| NSE Archives | `participant_wise_daily.csv` | Daily FII/PRO/DII/Client positions (separate) |
| NSE Archives | `sensex_fii_t1_6year.csv` | T-1 FII/PRO data for 318 expiry days |
